...
**Çiftçi**, Türkiye’de yaygın **~300 bitki** (ekimler, ağaçlar, süs bitkileri) için bir katalog ve [Pl@ntNet API](https://my.plantnet.org/) ile **bitki tanıma** sunan ücretsiz bir iOS uygulamasıdır.

---

## Özellikler

- **Katalog** — Yaklaşık 300 Türkiye genelinde yaygın bitkiyi Türkçe özet, bakım notları (güneş, toprak, su, gübre) ve gömülü görsellerle arayın.
- **Tanı** — **Ücretsiz Pl@ntNet API yardımıyla** fotoğraftan bitki tanıyın; sonuçlarda Türkçe ve bilimsel ad gösterilir, eşleşme varsa kataloğa gidilir.
...
# Gizlilik Politikası — Çiftçi

*Son güncelleme: 17 Mayıs 2026*

**Veri sorumlusu:** Onur Gün
**Uygulama:** Çiftçi 
**İletişim:** [gunonur@gmail.com](mailto:gunonur@gmail.com)

---

## 1. Genel bakış

Çiftçi, Türkiye’de yaygın bitkiler için bir katalog ve tanıma uygulamasıdır. Bu uygulama için **kullanıcı hesabı sistemi veya kendimize ait bir bulut sunucusu işletmiyoruz**.

## 2. Cihazınızda saklanan veriler

Uygulama iPhone veya iPad’inizde yerel olarak şunları saklayabilir:
...
| Bitki tanıma | Evet; Pl@ntNet API |
...
Tanı çalışmıyorsa: **Ayarlar**’da Pl@ntNet koşullarını kabul ettiğinizden, ve çiçek, yaprak veya meyvenin net göründüğü bir fotoğraf kullandığınızdan emin olun.
